...
public final class GymServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<edu.eci.arsw.wellness.gym.GymReserveRequest,
      edu.eci.arsw.wellness.gym.GymReserveResponse> getReserveGymSessionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ReserveGymSession",
      requestType = edu.eci.arsw.wellness.gym.GymReserveRequest.class,
      responseType = edu.eci.arsw.wellness.gym.GymReserveResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.eci.arsw.wellness.gym.GymReserveRequest,
      edu.eci.arsw.wellness.gym.GymReserveResponse> getReserveGymSessionMethod() {
    io.grpc.MethodDescriptor<edu.eci.arsw.wellness.gym.GymReserveRequest, edu.eci.arsw.wellness.gym.GymReserveResponse> getReserveGymSessionMethod;
      ...
      synchronized (GymServiceGrpc.class) {
        if ((getReserveGymSessionMethod = GymServiceGrpc.getReserveGymSessionMethod) == null) {
          GymServiceGrpc.getReserveGymSessionMethod = getReserveGymSessionMethod =
              io.grpc.MethodDescriptor.<edu.eci.arsw.wellness.gym.GymReserveRequest, edu.eci.arsw.wellness.gym.GymReserveResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ReserveGymSession"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.eci.arsw.wellness.gym.GymReserveRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.eci.arsw.wellness.gym.GymReserveResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void reserveGymSession(edu.eci.arsw.wellness.gym.GymReserveRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.wellness.gym.GymReserveResponse> responseObserver) {
  ...
  public static final class GymServiceStub
    ...
    /**
     */
    public void reserveGymSession(edu.eci.arsw.wellness.gym.GymReserveRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.wellness.gym.GymReserveResponse> responseObserver) {
  ...
  public static final class GymServiceBlockingStub
    ...
    /**
     */
    public edu.eci.arsw.wellness.gym.GymReserveResponse reserveGymSession(edu.eci.arsw.wellness.gym.GymReserveRequest request) {
  ...
  public static final class GymServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.eci.arsw.wellness.gym.GymReserveResponse> reserveGymSession(
        edu.eci.arsw.wellness.gym.GymReserveRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_RESERVE_GYM_SESSION:
          serviceImpl.reserveGymSession((edu.eci.arsw.wellness.gym.GymReserveRequest) request,
              (io.grpc.stub.StreamObserver<edu.eci.arsw.wellness.gym.GymReserveResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              edu.eci.arsw.wellness.gym.GymReserveRequest,
              edu.eci.arsw.wellness.gym.GymReserveResponse>(
  ...
  private static abstract class GymServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return edu.eci.arsw.wellness.gym.GymProto.getDescriptor();
    }
